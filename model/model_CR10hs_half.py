...
class Model_CR10_hsn_half(nn.Module):
    @staticmethod
    def padding():
    ...
    def __init__(self, slices, classes, image_height, pad_top=True, pad_bottom=True):
        super(Model_CR10_hsn_half, self).__init__()
        self.slices = slices
        ...
        for i in range(0, self.slices):
            ...
            self.conv_ds1.append(nn.Conv2d(16, 32, 5, padding=0, stride=2, groups=2)) # + 2 = 3
            self.conv_1.append(nn.Conv2d(32, 32, 3, padding=0, stride=1)) # + 2 x 1 = 5
            self.conv_2.append(nn.Conv2d(32, 32, 3, padding=0, stride=1, groups=4)) # + 2 x 1 = 7
            self.conv_3.append(nn.Conv2d(32, 64, 3, padding=0, stride=1)) # + 2 x 1 = 9
            self.conv_4.append(nn.Conv2d(64, 64, 3, padding=0, stride=1, groups=8))  # + 2 x 1 = 11
            self.conv_5.append(nn.Conv2d(64, 128, 3, padding=0, stride=1)) # + 2 x 1 = 13
            self.conv_6.append(nn.Conv2d(128, 128, 3, padding=0, stride=1, groups=16))
