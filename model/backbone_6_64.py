...
class Backbone6_64(nn.Module):
    def __init__(self):
        super(Backbone6_64, self).__init__()
        ...
        self.conv_3 = nn.Conv2d(32, 32, 3, padding=1, stride=1)  # + 2 x 1 = 9
        self.conv_4 = nn.Conv2d(32, 64, 3, padding=1, stride=1, groups=1 + 0 * 64)  # + 2 x 1 = 11
        self.conv_5 = nn.Conv2d(64, 64, 3, padding=1, stride=1)  # + 2 x 1 = 13
        self.conv_6 = nn.Conv2d(64, 64, 3, padding=1, stride=1, groups=1 + 0 * 128)  # + 2 x 1 = 17
