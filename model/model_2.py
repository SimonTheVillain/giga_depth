...
class Model2(nn.Module):
    ...
    def __init__(self):
        ...
        self.resi_block1 = ResidualBlock(64, 3, 1)
        self.resi_block2 = ResidualBlock(64, 3, 1)
        ...
        self.resi_block3 = ResidualBlock(64, 3, 1)
        self.resi_block4 = ResidualBlock(64, 3, 1)
        #pool 2
        self.conv_end_1 = nn.Conv2d(64, 128, 5, padding=2, padding_mode='same')
        self.resi_block10 = ResidualBlock(128, 3, 1)
