...
def apply_recursively(model, input_root, output_root, args):
    ...
    for file in files:
        ...
        if os.path.isdir(path_input):
            apply_recursively(model, path_input, path_output, args)
            print(path_input)
...
def run():
    ...
    apply_recursively(model, input_root, output_root, args)
