...
class Model_Lines_2(nn.Module):

    def __init__(self):
        super(Model_Lines_2, self).__init__()
        # 1 input image channel, 6 output channels, 3x3 square convolution
        # kernel
        self.conv_start = nn.Conv2d(1, 128, 3, padding=0, padding_mode='none') #1
        ...
        #pool 2
        self.conv_end_1 = nn.Conv2d(128, 256, 5, padding=0, padding_mode='none') #2
        self.resi_block10 = ResidualBlock_shrink(256, 1, 0, depadding=0) #0
        self.resi_block11 = ResidualBlock_shrink(256, 1, 0, depadding=0) #0
        #concatenate
        self.conv_end_2 = nn.Conv2d(256, 2, 1, padding=0, padding_mode='same') #0
