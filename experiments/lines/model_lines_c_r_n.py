...
class Model_Lines_C_R_n(nn.Module):
    ...
    def __init__(self, classes):
        ...
        #concatenate
        self.conv_end_2_c = nn.Conv2d(128, 1024, 1, padding=0, padding_mode='same')
        self.conv_end_3_c = nn.Conv2d(1024, classes+1, 1, padding=0, padding_mode='same') #0

        #two similar layers for the regression part of the output
        self.conv_end_2_r = nn.Conv2d(128, 1024, 1, padding=0, padding_mode='same')
        self.conv_end_3_r = nn.Conv2d(1024, classes, 1, padding=0, padding_mode='same') #0
